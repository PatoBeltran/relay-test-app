...
function subscribeRelay(_params: RequestParameters, _variables: Variables, _cacheConfig: CacheConfig) {
    return { dispose: () => null };
}
...
export default new Environment({
  ...
  } as any), // cast it to any since the types for this have not been yet updated
});
